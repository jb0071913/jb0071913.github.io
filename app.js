...
eval("// Module\nvar code = \"<div layout=\\\"row\\\">\\n    <md-switch ng-model=\\\"$ctrl.useTextButtons\\\" ng-change=\\\"$ctrl.useTextButtonsChanged({id: $ctrl.id, val: $ctrl.useTextButtons})\\\">Use text buttons</md-switch>\\n    <md-switch ng-model=\\\"$ctrl.includeModel\\\" ng-change=\\\"$ctrl.includeModelChanged({id: $ctrl.id, val: $ctrl.includeModel})\\\">Show Model</md-switch>\\n    <md-switch ng-model=\\\"$ctrl.logicTerms\\\" ng-change=\\\"$ctrl.logicTermsChanged({id: $ctrl.id, val: $ctrl.logicTerms})\\\">Use terms ALL/ANY</md-switch>\\n    <md-switch ng-model=\\\"$ctrl.entityTerms\\\" ng-change=\\\"$ctrl.entityTermsChanged({id: $ctrl.id, val: $ctrl.entityTerms})\\\">Use terms Filter/Group</md-switch>\\n</div>\";\n// Exports\nmodule.exports = code;\n\n//# sourceURL=webpack:///./app/demo/demo-options.component.html?");
